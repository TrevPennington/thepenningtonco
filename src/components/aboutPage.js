    ...
    <div className="aboutPageWrapper">
      <div className="headWrapper">
        <div className="aboutContentWrapper">
          <h1 className="headTitle titleFormat">Trevor + Shelby</h1>
          <div className="text">
            <p>{bio}</p>
            <p>{biotwo}</p>
            <p>{biothree}</p>
          ...
          <div className="contact">
            <h1 className="contactTitle titleFormat">
              Let's grab some coffee.
            </h1>
            <Link to="/inquire">
              {" "}
              <button className="contactLink">say hello</button>
            </Link>
          </div>
        </div>
