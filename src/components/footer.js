  ...
  <div className="footerWrapper">
    <div className="contentWrapper">
      <div className="social">
        <a href="https://www.instagram.com/thepennington.co/" target="_blank">
          <Insta size="27px" />
        </a>
        <a href="https://www.facebook.com/thepennington.co/" target="_blank">
          <Faceboo size="18px" />
        </a>
        <a href="https://www.pinterest.com/thepenningtonco/" target="_blank">
          <Pinterest size="25px" />
        </a>
      </div>
      <h1 className="footerCreator">
        <a
          href="https://www.trevorpennington.com/"
          target="_blank"
          style={{ color: `#333` }}
        >
